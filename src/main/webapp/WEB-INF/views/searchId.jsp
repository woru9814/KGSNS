...
<body>
	<form action="searchId.do" method="post" onsubmit="return sendCheck();" >
		<table border="0" align="center">
			...
			<tr>
				...
				<td align="left"><input type="text" name="memname" class="textbox" required autofocus></td>
			</tr>
			<tr>
		...
		<table border="0" align="center">
			<tr>
				<td colspan="2"  class="btnwrap2">
					<input type="submit" value="ID 찾기" class="btn-sign">&nbsp;
